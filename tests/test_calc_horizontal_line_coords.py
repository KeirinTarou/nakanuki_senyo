...
def test_calc_horizontal_line_coords_larger_than_canvas():
    """ w, hともにキャンバスよりも大きい"""
    line1, line2 = \
        NakanukiApp.calc_horizontal_line_coords(
            canvas_size=(600, 400), 
...
def test_calc_horizontal_line_coords_smaller_than_canvas():
    """ w, hともにキャンバスよりも小さい"""
    line1, line2 = \
        NakanukiApp.calc_horizontal_line_coords(
            canvas_size=(600, 400), 
...
def test_calc_horizontal_line_coords_w_larger_than_canvas():
    """ wがキャンバスよりも大きい"""
    line1, line2 = \
        NakanukiApp.calc_horizontal_line_coords(
            canvas_size=(600, 400), 
...
def test_calc_horizontal_line_coords_h_larger_than_canvas():
    """ hがキャンバスよりも大きい"""
    line1, line2 = \
        NakanukiApp.calc_horizontal_line_coords(
            canvas_size=(600, 400), 
