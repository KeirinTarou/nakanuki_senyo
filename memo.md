...
- pyinstallerコマンド
    - `nakanuki_senyo`ディレクトリをカレントディレクトリにして実行
```bash
pyinstaller --onefile --noconsole --name nakanuki --add-data "src/resources/nakanuki.ico;." --add-data "src/resources/breakline.png;." --icon src/resources/nakanuki.ico run.py
```
